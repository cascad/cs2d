...
// ПАТЧ CS2D: 1200 → 1024. Датаграмма WebTransport должна влезть в QUIC-пакет
// (~1200 байт path MTU) вместе с заголовками QUIC и обёрткой netcode; пакеты
// размером ровно 1200 сервер молча дропал (SendDatagramError::TooLarge) — из-за
// этого репликация не доходила до браузерного клиента.
